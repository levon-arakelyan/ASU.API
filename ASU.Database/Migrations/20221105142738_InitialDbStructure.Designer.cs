...
namespace ASU.Database.Migrations
{
    ...
    [Migration("20221105142738_InitialDbStructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASU.Core.Entities.Audience", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.CourseSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.StudentSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.TeacherSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASU.Core.Entities.Course", b =>
                {
                    b.HasOne("ASU.Core.Entities.Profession", "Profession")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ASU.Core.Entities.CourseSubject", b =>
                {
                    b.HasOne("ASU.Core.Entities.Course", "Course")
                        .WithMany("CourseSubjects")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ASU.Core.Entities.Subject", "Subject")
                        .WithMany("CourseSubjects")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ASU.Core.Entities.Teacher", "Teacher")
                        .WithMany("CourseSubjects")
            ...
            modelBuilder.Entity("ASU.Core.Entities.Schedule", b =>
                {
                    b.HasOne("ASU.Core.Entities.Audience", "Audience")
                        .WithMany("Schedule")
            ...
            modelBuilder.Entity("ASU.Core.Entities.StudentSubject", b =>
                {
                    ...
                    b.HasOne("ASU.Core.Entities.Student", "Student")
                        .WithMany("StudentSubjects")
